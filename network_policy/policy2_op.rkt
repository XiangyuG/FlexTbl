...
(define (impl ip)
  (let* (
         ...
         (choose ip ((choose bvand bvor) (choose ip (bv #xFFFFFF00 32) (bv #xFFFF0000 32) (bv #xFF000000 32) (bv #x0A010100 32) (bv #x0A000000 32)) (choose ip (bv #xFFFFFF00 32) (bv #xFFFF0000 32) (bv #xFF000000 32) (bv #x0A010100 32) (bv #x0A000000 32))) )
         (choose (bv #xFFFFFF00 32) (bv #xFFFF0000 32) (bv #xFF000000 32) (bv #x0A010100 32) (bv #x0A000000 32) ip ))]
