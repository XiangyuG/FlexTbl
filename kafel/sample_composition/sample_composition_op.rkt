...
(assert (and (>= cost0 0) (>= cost0L 0) (>= cost0R 0) (>= cost0LL 0) (>= cost0LR 0) (>= cost0RL 0) (>= cost0RR 0)))

(define (spec fdhi fdlo)
  (cond
    [(and (bveq fdhi (bv 0 32)) (bveq fdlo (bv 1 32))) (bv 0 1)] ;; ALLOW
    [(and (bveq fdhi (bv 0 32)) (bveq fdlo (bv 2 32))) (bv 0 1)] ;; ALLOW
    [else               (bv 1 1)]))   ;; KILL

(define (impl fdhi fdlo)
  (let* (
         [cond-expr0 ((choose bveq bvult bvugt bvule bvuge (not bveq)) 
         (choose fdhi fdlo ((choose bvand bvor) (choose fdhi fdlo ) (choose fdhi fdlo (bv 1 32) (bv 2 32) (bv 0 32))) )
         (choose (bv 1 32) (bv 2 32) (bv 0 32) fdhi fdlo ))]
...
(define sol
   (synthesize
     ...
     #:guarantee (begin
      (assert (and (bveq (impl fdhi fdlo) (spec fdhi fdlo)) (= total-cost 3)))
    ))
)
