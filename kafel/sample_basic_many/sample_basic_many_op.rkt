...
(define-symbolic sys (bitvector 32))
...
(define (spec sys)
  (cond
    [(or (bveq sys (bv 0 32)) (bveq sys (bv 1 32)) (bveq sys (bv 2 32)) (bveq sys (bv 8 32))) (bv 0 1)] ;; ALLOW
    [else               (bv 1 1)]))   ;; KILL

(define (impl sys)
  (let* (
         [cond-expr0 ((choose bveq bvult bvugt bvule bvuge bvne)
         (choose sys ((choose bvand bvor) (choose sys (bv 0 32) (bv 1 32) (bv 2 32) (bv 8 32)) (choose sys (bv 0 32) (bv 1 32) (bv 2 32) (bv 8 32))))
         (choose (bv 0 32) (bv 1 32) (bv 2 32) (bv 8 32) sys))]
...
(define sol
   (synthesize
     #:forall    (list sys)
     #:guarantee (begin
      (assert (and (bveq (impl sys) (spec sys)) (= total-cost 2)))
    ))
)
