...
(define (impl flag)
  (let* (
         ...
         (choose flag ((choose bvand bvor) (choose flag (bv 66 32) (bv 65 32)) (choose flag (bv 66 32) (bv 65 32))) )
         (choose (bv 3261507367 32) (bv 66 32) (bv 65 32) flag))]

         [cond-expr0L ((choose bveq bvult bvugt bvule bvuge (not bveq)) 
         (choose flag ((choose bvand bvor) (choose flag (bv 66 32) (bv 65 32)) (choose flag (bv 66 32) (bv 65 32))) )
         (choose (bv 66 32) (bv 65 32) flag))]
...
(define sol
   (synthesize
     #:forall    (list flag)
     #:guarantee (begin
      (assert (and (bveq (impl flag) (spec flag)) (= total-cost 2)))
    ))
)
