...
(define (spec bufhi buflo)
  (cond
    [(and (bveq (bvand bufhi (bv 3261507367 32)) (bv 3261507367 32)) (bveq (bvand buflo (bv 2361667381 32)) (bv 2361667381 32))) (bv 0 1)] ;; ALLOW
    [else               (bv 1 1)]))   ;; KILL

(define (impl bufhi buflo)
  (let* (
         [cond-expr0 ((choose bveq bvult bvugt bvule bvuge (not bveq)) 
         (choose bufhi buflo ((choose bvand bvor) (choose bufhi buflo ) (choose bufhi buflo (bv 3261507367 32) (bv 2361667381 32))) )
         (choose (bv 3261507367 32) (bv 2361667381 32) bufhi buflo ))]
