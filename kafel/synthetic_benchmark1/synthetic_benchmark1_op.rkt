...
(define (impl fdhi fdlo)
  (let* (
         ...
         (choose fdhi fdlo ((choose bvand bvor) (choose fdhi fdlo ) (choose fdhi fdlo (bv 1 32) (bv 0 32))) )
         (choose (bv 1 32) (bv 0 32) fdhi fdlo ))]
...
(define sol
   (synthesize
     ...
     #:guarantee (begin
      (assert (and (bveq (impl fdhi fdlo) (spec fdhi fdlo)) (= total-cost 2)))
    ))
)
