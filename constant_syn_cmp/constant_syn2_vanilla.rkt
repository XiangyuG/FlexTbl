...
;; impl:
(define (impl2 proto srcIP dstIP srcPort dstPort)
...
(define (impl2vanila proto srcIP dstIP srcPort dstPort)
...
(define sol
  (synthesize
   ...
   #:guarantee
   (begin
    (assert (bveq (spec2 proto srcIP dstIP srcPort dstPort) (impl2vanila proto srcIP dstIP srcPort dstPort)))
   )
   ))
