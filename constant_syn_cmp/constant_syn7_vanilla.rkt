...
(define (spec7 proto srcIP dstIP srcPort dstPort)
...
;; impl:
(define (impl7 proto srcIP dstIP srcPort dstPort)
...
(define (impl7vanilla proto srcIP dstIP srcPort dstPort)
...
(define sol
  (synthesize
   ...
   #:guarantee
   (begin
    (assert (bveq (spec7 proto srcIP dstIP srcPort dstPort) (impl7vanilla proto srcIP dstIP srcPort dstPort)))
   )
   ))
