...
(define (spec10 proto srcIP dstIP srcPort dstPort)
...
;; impl:
(define (impl10 proto srcIP dstIP srcPort dstPort)
...
(define (impl10vanilla proto srcIP dstIP srcPort dstPort)
...
(define sol
  (synthesize
   ...
   #:guarantee
   (begin
    (assert (bveq (spec10 proto srcIP dstIP srcPort dstPort) (impl10vanilla proto srcIP dstIP srcPort dstPort)))
   )
   ))
