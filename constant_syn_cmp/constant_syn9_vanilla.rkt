...
(define (spec9 proto srcIP dstIP srcPort dstPort)
...
;; impl:
(define (impl9 proto srcIP dstIP srcPort dstPort)
...
(define (impl9vanilla proto srcIP dstIP srcPort dstPort)
...
(define sol
  (synthesize
   ...
   #:guarantee
   (begin
    (assert (bveq (spec9 proto srcIP dstIP srcPort dstPort) (impl9vanilla proto srcIP dstIP srcPort dstPort)))
   )
   ))
