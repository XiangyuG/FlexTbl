...
(define (spec5 proto srcIP dstIP srcPort dstPort)
...
;; impl:
(define (impl5 proto srcIP dstIP srcPort dstPort)
...
(define (impl5vanilla proto srcIP dstIP srcPort dstPort)
...
(define sol
  (synthesize
   ...
   #:guarantee
   (begin
    (assert (bveq (spec5 proto srcIP dstIP srcPort dstPort) (impl5vanilla proto srcIP dstIP srcPort dstPort)))
   )
   ))
