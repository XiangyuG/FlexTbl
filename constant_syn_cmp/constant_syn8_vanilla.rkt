...
(define (spec8 proto srcIP dstIP srcPort dstPort)
...
;; impl:
(define (impl8 proto srcIP dstIP srcPort dstPort)
...
(define (impl8vanilla proto srcIP dstIP srcPort dstPort)
...
(define sol
  (synthesize
   ...
   #:guarantee
   (begin
    (assert (bveq (spec8 proto srcIP dstIP srcPort dstPort) (impl8vanilla proto srcIP dstIP srcPort dstPort)))
   )
   ))
