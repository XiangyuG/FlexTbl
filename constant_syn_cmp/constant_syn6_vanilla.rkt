...
(define (spec6 proto srcIP dstIP srcPort dstPort)
...
;; impl:
(define (impl6 proto srcIP dstIP srcPort dstPort)
...
(define (impl6vanilla proto srcIP dstIP srcPort dstPort)
...
(define sol
  (synthesize
   ...
   #:guarantee
   (begin
    (assert (bveq (spec6 proto srcIP dstIP srcPort dstPort) (impl6vanilla proto srcIP dstIP srcPort dstPort)))
   )
   ))
