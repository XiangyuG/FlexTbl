...
(define (spec20 proto srcIP dstIP srcPort dstPort)
...
;; impl:
(define (impl20 proto srcIP dstIP srcPort dstPort)
...
(define (impl20vanilla proto srcIP dstIP srcPort dstPort)
...
(define sol
  (synthesize
   ...
   #:guarantee
   (begin
    (assert (bveq (spec20 proto srcIP dstIP srcPort dstPort) (impl20vanilla proto srcIP dstIP srcPort dstPort)))
   )
   ))
