...
(define (spec4 proto srcIP dstIP srcPort dstPort)
...
;; impl:
(define (impl4 proto srcIP dstIP srcPort dstPort)
...
(define (impl4vanilla proto srcIP dstIP srcPort dstPort)
...
(define sol
  (synthesize
   ...
   #:guarantee
   (begin
    (assert (bveq (spec4 proto srcIP dstIP srcPort dstPort) (impl4vanilla proto srcIP dstIP srcPort dstPort)))
   )
   ))
