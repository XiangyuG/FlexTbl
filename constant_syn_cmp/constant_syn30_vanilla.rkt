...
(define (spec30 proto srcIP dstIP srcPort dstPort)
...
;; impl:
(define (impl30 proto srcIP dstIP srcPort dstPort)
...
(define (impl30vanilla proto srcIP dstIP srcPort dstPort)
...
(define sol
  (synthesize
   ...
   #:guarantee
   (begin
    (assert (bveq (spec30 proto srcIP dstIP srcPort dstPort) (impl30vanilla proto srcIP dstIP srcPort dstPort)))
   )
   ))
